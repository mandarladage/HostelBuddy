...
import 'package:my_mega_project/fortest/UploadMyself.dart';
...
import 'DownloadStorage/DisplayFetchData.dart';
import 'DownloadStorage/SecondSubList.dart';
import 'DownloadStorage/SubListView.dart';
import 'Lists/ListCard.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: SplashScreen(3, HostelLogin()), //Welcome_Screen
    );
  }
}
...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<Map<String, dynamic>>> _loadImages() async {
    ...
    final ListResult result = await storage.ref('Hostel/h_profile/').list();
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListCard(image['url'], 'MyHostel');
                      },
                    );
                  }
